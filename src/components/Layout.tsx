...
import { LayoutDashboard, Users, ShoppingBag, Receipt, Settings, FileDown, LogOut, Menu, UserCog, HeartHandshake, Loader2, AlertCircle, Activity, X, Map, Trophy, Megaphone, Music, Star, Gamepad2 } from 'lucide-react';
...
export default function Layout() {
  ...
  if (isAdmin) {
    navigation.push({ name: 'Games', href: '/games', icon: Gamepad2 });
  }
  navigation.push({ name: 'Awards', href: '/awards', icon: Star });
